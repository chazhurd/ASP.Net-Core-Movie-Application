...
namespace MvcMovie.Controllers
{
    public class MoviesController : Controller
    {
        ...
        // GET: Movies
        //If the string past Movies?(searchString=moviename) then this Linq will execute.
        // Or you can use the id will be used since we have pattern of controller(home)/action(index)/id?
        // movies/index/idofmovie
        /*[HttpGet]
